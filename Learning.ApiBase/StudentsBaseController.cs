...
{
    public class StudentsBaseController : BaseApiController
    {
        public StudentsBaseController(ILearningRepository repo)
            : base(repo)
        {
        }

        //[VersionedRoute("~/api/students", 1, "Students")]
        public virtual IEnumerable<StudentBaseModel> Get(int page = 0, int pageSize = 10)
        {
        ...
        //[LearningAuthorize]
        [Route("{userName}")]
        public virtual HttpResponseMessage Get(string userName)
        {
            try
            {
        ...
        public virtual HttpResponseMessage Post([FromBody] Student student)
        {
            try
            {
        ...
        [HttpPatch]
        [HttpPut]
        public virtual HttpResponseMessage Put(string userName, [FromBody] Student student)
        {
            try
            {
        ...
        public virtual HttpResponseMessage Delete(string userName)
        {
            try
            {
